...
bool ch3_interfaces__msg__weather__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ch3_interfaces.msg._weather.Weather", full_classname_dest, 35) == 0);
  }
  ch3_interfaces__msg__Weather * ros_message = _ros_message;
  {  // temperature
...
{
  /* NOTE(esteve): Call constructor of Weather */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ch3_interfaces.msg._weather");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Weather");
