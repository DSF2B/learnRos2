...
class Metaclass_Weather(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('ch3_interfaces')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'ch3_interfaces.msg.Weather')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__weather
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__weather
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__weather
            cls._TYPE_SUPPORT = module.type_support_msg__msg__weather
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__weather
