...
#include "ch3_status_interfaces/msg/detail/system_status__rosidl_typesupport_fastrtps_c.h"
...
#include "ch3_status_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_ch3_status_interfaces
...
using _SystemStatus__ros_msg_type = ch3_status_interfaces__msg__SystemStatus;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ch3_status_interfaces
size_t get_serialized_size_ch3_status_interfaces__msg__SystemStatus(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SystemStatus__ros_msg_type * ros_message = static_cast<const _SystemStatus__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _SystemStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ch3_status_interfaces__msg__SystemStatus(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ch3_status_interfaces
size_t max_serialized_size_ch3_status_interfaces__msg__SystemStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ch3_status_interfaces__msg__SystemStatus;
    is_plain =
      (
...
static size_t _SystemStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ch3_status_interfaces__msg__SystemStatus(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ch3_status_interfaces, msg, SystemStatus)() {
