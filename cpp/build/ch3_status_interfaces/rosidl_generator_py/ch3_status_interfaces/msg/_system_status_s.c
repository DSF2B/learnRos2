...
bool ch3_status_interfaces__msg__system_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ch3_status_interfaces.msg._system_status.SystemStatus", full_classname_dest, 53) == 0);
  }
  ch3_status_interfaces__msg__SystemStatus * ros_message = _ros_message;
  {  // stamp
...
PyObject * ch3_status_interfaces__msg__system_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ch3_status_interfaces.msg._system_status");
