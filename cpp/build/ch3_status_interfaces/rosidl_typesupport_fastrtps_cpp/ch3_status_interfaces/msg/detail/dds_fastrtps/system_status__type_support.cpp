...
#include "ch3_status_interfaces/msg/detail/system_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ch3_status_interfaces
cdr_serialize(
  const ch3_status_interfaces::msg::SystemStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ch3_status_interfaces::msg::SystemStatus & ros_message)
{
  // Member: stamp
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ch3_status_interfaces::msg::SystemStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ch3_status_interfaces::msg::SystemStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ch3_status_interfaces::msg::SystemStatus *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_ch3_status_interfaces
const rosidl_message_type_support_t *
get_message_type_support_handle<ch3_status_interfaces::msg::SystemStatus>()
{
  return &ch3_status_interfaces::msg::typesupport_fastrtps_cpp::_SystemStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ch3_status_interfaces, msg, SystemStatus)() {
  return &ch3_status_interfaces::msg::typesupport_fastrtps_cpp::_SystemStatus__handle;
}
