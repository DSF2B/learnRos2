...
#ifndef CH3_STATUS_INTERFACES__MSG__DETAIL__SYSTEM_STATUS__STRUCT_HPP_
#define CH3_STATUS_INTERFACES__MSG__DETAIL__SYSTEM_STATUS__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__ch3_status_interfaces__msg__SystemStatus __attribute__((deprecated))
#else
# define DEPRECATED__ch3_status_interfaces__msg__SystemStatus __declspec(deprecated)
#endif
...
struct SystemStatus_
{
  ...
  // pointer types
  using RawPtr =
    ch3_status_interfaces::msg::SystemStatus_<ContainerAllocator> *;
  using ConstRawPtr =
    const ch3_status_interfaces::msg::SystemStatus_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<ch3_status_interfaces::msg::SystemStatus_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<ch3_status_interfaces::msg::SystemStatus_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      ch3_status_interfaces::msg::SystemStatus_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<ch3_status_interfaces::msg::SystemStatus_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<ch3_status_interfaces::msg::SystemStatus_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<ch3_status_interfaces::msg::SystemStatus_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<ch3_status_interfaces::msg::SystemStatus_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__ch3_status_interfaces__msg__SystemStatus
    std::shared_ptr<ch3_status_interfaces::msg::SystemStatus_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__ch3_status_interfaces__msg__SystemStatus
    std::shared_ptr<ch3_status_interfaces::msg::SystemStatus_<ContainerAllocator> const>
...
using SystemStatus =
  ch3_status_interfaces::msg::SystemStatus_<std::allocator<void>>;
...
#endif  // CH3_STATUS_INTERFACES__MSG__DETAIL__SYSTEM_STATUS__STRUCT_HPP_
